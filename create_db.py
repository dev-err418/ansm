...
def vectorize_and_append(to_embed_dense: str, to_embed_sparse: str, payload: Dict):
...
def recursive_sub_or_content(sub: str, branch: Dict, path: str):
    if sub == "content": # on a un child et du contenu
        ...
        vectorize_and_append(
            ...
            payload={
                "content": content,
                "title": title
            } # le contenu affiché dans la DB pour se reperer
        )
